import {
  createContext, PropsWithChildren, ReactElement, useState,
} from 'react';
...
export const AppContextProvider = ({ menu, firstCategory, children }: PropsWithChildren<IAppContext>): ReactElement => {
